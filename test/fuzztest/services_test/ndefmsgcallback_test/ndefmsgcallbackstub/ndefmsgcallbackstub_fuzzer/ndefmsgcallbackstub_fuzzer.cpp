 ...
 */
#include "ndefmsgcallbackstub_fuzzer.h"
...
namespace OHOS {
    ...
    void FuzzOnRemoteRequest(const uint8_t* data, size_t size)
    {
        ...
        NFC::NdefMsgCallbackStub &ndefMsgCallbackStub = NFC::NdefMsgCallbackStub::GetInstance();
        ndefMsgCallbackStub.OnRemoteRequest(static_cast<uint32_t>(
            NFC::NfcServiceIpcInterfaceCode::COMMAND_ON_NDEF_MSG_NOTIFY), data2, reply, option);
    }
