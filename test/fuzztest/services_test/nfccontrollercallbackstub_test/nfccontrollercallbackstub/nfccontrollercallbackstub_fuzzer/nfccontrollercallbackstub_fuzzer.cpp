...
namespace OHOS {
    ...
    constexpr uint32_t MESSAGE_SIZE = NFC::NfcServiceIpcInterfaceCode::COMMAND_NFC_CONTROLLER_CALLBACK_STUB_BOTTOM;
    ...
    bool DoNfcControllerCallBackStubFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::DoNfcControllerCallBackStubFuzzTest(data, size);
    return 0;
}
