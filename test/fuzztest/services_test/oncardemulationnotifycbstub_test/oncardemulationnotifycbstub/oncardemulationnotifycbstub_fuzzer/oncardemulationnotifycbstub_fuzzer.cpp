 ...
 */
#include "oncardemulationnotifycbstub_fuzzer.h"
...
namespace OHOS {
    ...
    bool DoOnCardEmulationNotifyCbStubFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        MessageParcel datas;
        std::u16string descriptor = OnCardEmulationNotifyCbStub::GetDescriptor();
        ...
        OnCardEmulationNotifyCbStub::GetInstance().OnRemoteRequest(code, datas, reply, option);
        return true;
    }
