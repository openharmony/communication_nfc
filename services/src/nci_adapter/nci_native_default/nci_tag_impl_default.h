...
namespace NFC {
namespace NCI {
class NciTagImplDefault final : public INciTagInterface {
public:
    explicit NciTagImplDefault();
    ~NciTagImplDefault();
...
private:
    std::weak_ptr<INciTagInterface> nciTagInterface_;
};
}  // namespace NCI
}  // namespace NFC
}  // namespace OHOS
#endif  // NCI_TAG_IMPL_DEFAULT_H
