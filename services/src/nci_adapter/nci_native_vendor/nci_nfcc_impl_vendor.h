 ...
 */
#ifndef NCI_NFCC_IMPL_VENDOR_H
#define NCI_NFCC_IMPL_VENDOR_H
#include "inci_nfcc_interface.h"

namespace OHOS {
namespace NFC {
namespace NCI {
class NciNfccImplVendor final : public INciNfccInterface {
public:
    NciNfccImplVendor();
    ~NciNfccImplVendor();
...
private:
    std::shared_ptr<INciNfccInterface> vendorNfccImpl_;
};
}  // namespace NCI
}  // namespace NFC
}  // namespace OHOS
#endif /* NCI_NFCC_IMPL_VENDOR_H */
