 ...
 */
#ifndef NCI_CE_IMPL_VENDOR_H
#define NCI_CE_IMPL_VENDOR_H
#include "inci_ce_interface.h"

namespace OHOS {
namespace NFC {
namespace NCI {
class NciCeImplVendor final : public INciCeInterface {
public:
    NciCeImplVendor();
    ~NciCeImplVendor();
...
private:
    std::shared_ptr<INciCeInterface> vendorCeImpl_;
};
}  // namespace NCI
}  // namespace NFC
}  // namespace OHOS
#endif /* NCI_CE_IMPL_VENDOR_H */
