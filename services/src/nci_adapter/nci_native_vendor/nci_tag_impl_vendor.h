 ...
 */
#ifndef NCI_TAG_IMPL_VENDOR_H
#define NCI_TAG_IMPL_VENDOR_H
#include "inci_tag_interface.h"

namespace OHOS {
namespace NFC {
namespace NCI {
class NciTagImplVendor final : public INciTagInterface {
public:
    explicit NciTagImplVendor();
    ~NciTagImplVendor();
...
private:
    std::shared_ptr<INciTagInterface> vendorTagImpl_;
};
}  // namespace NCI
}  // namespace NFC
}  // namespace OHOS
#endif  // NCI_TAG_IMPL_VENDOR_H
