...
class ConnectedTagServiceImpl : public SystemAbility, public ConnectedTagSessionStub {
DECLARE_SYSTEM_ABILITY(ConnectedTagServiceImpl);
public:
    ConnectedTagServiceImpl();
    virtual ~ConnectedTagServiceImpl();

    static sptr<ConnectedTagServiceImpl> GetInstance();
...
private:
    static sptr<ConnectedTagServiceImpl> g_instance;
