...
class ConnectedTagSessionStub : public IRemoteStub<ITagSession> {
public:
    ConnectedTagSessionStub();
    virtual ~ConnectedTagSessionStub();

    using handleFunc = void (ConnectedTagSessionStub::*)(uint32_t code, MessageParcel &data, MessageParcel &reply);
